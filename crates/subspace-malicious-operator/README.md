...
When the operator submits malicious content to the consensus chain, the honest operators in the network will detect and submit fraud proofs that target this content, and cause the malicious operator being slashed and baned from submitting bundle.
